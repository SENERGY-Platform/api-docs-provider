...
require (
	github.com/SENERGY-Platform/api-docs-provider/lib/models v0.0.0-00010101000000-000000000000
...
replace github.com/SENERGY-Platform/api-docs-provider/lib/models => ./lib/models
